...
void start_stop_initialize(sys_in_t *ss_s_system_input, sys_out_t *ss_s_system_returns)
{
    ...
    else
    {
        ss_s_system_returns->ss_b_hardware_ok = hardware_check_hardware(
            ss_s_system_input->ss_b_speed_sensor_broken,
            ss_s_system_input->ss_b_brake_sensor_broken,
            ss_s_system_input->ss_b_engine_temp_sensor_broken,
            ss_s_system_input->ss_b_battery_sensor_broken,
            ss_s_system_input->ss_b_hood_sensor_broken,
            ss_s_system_input->ss_b_trunk_sensor_broken,
            ss_s_system_input->ss_b_door_sensor_broken,
            ss_s_system_input->ss_b_seatbelt_sensor_broken,
            ss_s_system_input->ss_b_air_cond_sensor_broken
        );
        ...
        else
        {
            ss_s_system_returns->ss_b_safety_ok = safety_check_safety(
                ss_s_system_input->ss_b_hood_open,
                ss_s_system_input->ss_b_trunk_open,
                ss_s_system_input->ss_b_door_open,
                ss_s_system_input->ss_b_seatbelt_not_fastened
            );
