...
fixed7_9_t test_engine_internal_temp;
...
void testCheckEngineTemp_true(void)
{
    ...
    TEST_ASSERT(power_check_engine_temp(test_engine_internal_temp, FIXED7_9_FRAC) == 1);
}
...
void testCheckEngineTemp_false(void)
{
    ...
    TEST_ASSERT(power_check_engine_temp(test_engine_internal_temp, FIXED7_9_FRAC) == 0);
}
...
void testCheckBattery_true(void)
{
    ...
    TEST_ASSERT(power_check_battery(test_state_of_charge, FIXED1_15_FRAC) == 1);
}
...
void testCheckBattery_false(void)
{
    ...
    TEST_ASSERT(power_check_battery(test_state_of_charge, FIXED1_15_FRAC) == 0);
}
